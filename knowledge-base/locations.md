...
Postcode prefixes: LU, MK, SG, AL, HP

## Also serving
Milton Keynes, Northampton, Cambridge (listed in the footer and in the structured data
`areaServed`, but without the detailed town breakdown given to the three primary
regions above).
...
- LE → Leicester area
- LU, MK, SG, AL, HP → Luton & Bedfordshire area
