...
Head office: 75 Ringwood Bretton, Peterborough, PE3 9SR, United Kingdom.

## Why customers choose us

- **Our Quality** — Whether the style is classic or contemporary, the company partners
  with industry-leading suppliers for durable, premium materials and fabrics
  manufactured to a high standard.
- **Our Approach** — Every customer is different. Advisors take time to understand
...
- **Our Care** — Experts measure windows and install new blinds with precision, taking
  ...
  guarantee (see `warranty.md`).

## Trust signals

- Free measuring included
- Free professional fitting
- Lowest price guaranteed (price-match promise)
- 1-year peace of mind warranty
- Over 300+ five-star reviews claimed on the site (Google, Trustpilot, Facebook review
  logos displayed)
- The site links out to a Trustpilot business page, but as of the last content review
  there was no live Trustpilot review count/score integrated — do not quote a specific
  Trustpilot star rating or review count as confirmed unless the customer is pointed to
  the Trustpilot page itself.

## Supplier brands

The company states it supplies and fits products from these brands: Decora, Louvolite,
Alutrade, Urban Shutters.
